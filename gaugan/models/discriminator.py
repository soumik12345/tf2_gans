...
def build_discriminator(image_size: int = 256, downsample_factor: int = 64):
    image_1 = keras.Input(shape=[image_size, image_size, 3])
    image_2 = keras.Input(shape=[image_size, image_size, 3])
    ...
    return keras.Model([image_1, image_2], [x1, x2, x3, x4, x5], name="discriminator")
